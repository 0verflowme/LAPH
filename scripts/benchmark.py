...
def print_row(row: dict):
    print(
        ...
        "rho={fabqnf_rho:3d} out={fabqnf_out_dim:4d} hid={fabqnf_hid_dim:4d} "
        "max_rho={max_component_rho:3d} max_kappa={max_component_kappa:3d} "
        "table_fail={component_table_failures:3d} "
